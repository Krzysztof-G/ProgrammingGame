...
namespace ProgrammingGame.Data.Migrations
{
    ...
    [Migration("20170117000328_FixTypeFieldsNaming")]
    partial class FixTypeFieldsNaming
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("ProgrammingGame.Data.Entities.EventLog", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("ProgrammingGame.Data.Entities.EventLogType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("ProgrammingGame.Data.Entities.EventLog", b =>
                {
                    ...
                    b.HasOne("ProgrammingGame.Data.Entities.EventLogType", "Type")
                        .WithMany()
            ...
            modelBuilder.Entity("ProgrammingGame.Data.Entities.Indicator", b =>
                {
                    ...
                    b.HasOne("ProgrammingGame.Data.Entities.IndicatorType", "Type")
                        .WithMany()
                        .HasForeignKey("TypeId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("ProgrammingGame.Data.Entities.OwnedItem", b =>
                {
                    ...
                    b.HasOne("ProgrammingGame.Data.Entities.ItemType", "Type")
                        .WithMany()
                        .HasForeignKey("TypeId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
